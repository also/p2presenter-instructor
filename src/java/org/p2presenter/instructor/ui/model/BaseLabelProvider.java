 ...
 */
public class BaseLabelProvider extends LabelProvider implements
    ...
    private IPropertyListener editorRegistryListener = new IPropertyListener() {
		public void propertyChanged(Object source, int propId) {
			if (propId == IEditorRegistry.PROP_CONTENTS) {
				fireLabelProviderChanged(new LabelProviderChangedEvent(BaseLabelProvider.this));
			}
		}
	};
    ...
    protected final IWorkbenchAdapter getAdapter(Object o) {
    	IWorkbenchAdapter result = null;
        if (o instanceof IAdaptable) {
            result = (IWorkbenchAdapter) ((IAdaptable) o)
            .getAdapter(IWorkbenchAdapter.class);
        }
        if (result == null && o != null) {
        	result = (IWorkbenchAdapter) Platform.getAdapterManager().loadAdapter(o, IWorkbenchAdapter.class.getName());
        }
